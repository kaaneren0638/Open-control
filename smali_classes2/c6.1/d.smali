...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lc6/d;->a:Lq6/e;
    ...
    iput-object v0, p0, Lc6/d;->b:Lkotlinx/coroutines/flow/s;
    ...
    iput-object v1, p0, Lc6/d;->c:Lkotlinx/coroutines/flow/l;
...
.method public final a(Landroid/app/Activity;Li6/l;ZLandroid/app/Application;La6/j;ZLcom/zipoapps/premiumhelper/util/G;)V
    ...
    invoke-virtual {p0}, Lc6/d;->e()Lq6/d;
    ...
    const-string v5, "showInterstitialAd()-> called"

    invoke-virtual {v0, v5, v2}, LF7/a$c;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0}, Lc6/d;->d()Z
    ...
    const-string v2, "showInterstitialAd()-> isInterstitialLoaded = false"

    new-array v5, v1, [Ljava/lang/Object;

    invoke-virtual {v0, v2, v5}, LF7/a$c;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, v5, v6}, Lc6/d;->b(Landroid/app/Activity;La6/j;Z)V
    ...
    invoke-virtual {v0, v2}, Lk6/b;->h(Lk6/b$c;)Ljava/lang/Object;
    ...
    const-string v4, "Ad-fraud protection"

    const-string v5, ""

    invoke-direct {v0, v2, v4, v5}, La6/r;-><init>(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "Trying to show interstitial Ad from non-active lifecycle scope."

    invoke-direct {v0, v2, v4, v1}, La6/r;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method public final b(Landroid/app/Activity;La6/j;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lc6/d$a;-><init>(Landroid/app/Activity;La6/j;Lc6/d;LN6/d;Z)V
...
.method public final c(JLN6/d;)Ljava/lang/Object;
    ...
    instance-of v0, p3, Lc6/d$b;

    if-eqz v0, :cond_0

    move-object v0, p3

    check-cast v0, Lc6/d$b;

    iget v1, v0, Lc6/d$b;->f:I
    ...
    invoke-direct {v0, p0, p3}, Lc6/d$b;-><init>(Lc6/d;LN6/d;)V

    :goto_0
    iget-object p3, v0, Lc6/d$b;->d:Ljava/lang/Object;

    sget-object v1, LO6/a;->COROUTINE_SUSPENDED:LO6/a;

    iget v2, v0, Lc6/d$b;->f:I
    ...
    iget-object p1, v0, Lc6/d$b;->c:Lc6/d;
    ...
    new-instance p3, Lc6/d$c;

    const/4 v2, 0x0

    invoke-direct {p3, p0, v2}, Lc6/d$c;-><init>(Lc6/d;LN6/d;)V

    iput-object p0, v0, Lc6/d$b;->c:Lc6/d;

    iput v3, v0, Lc6/d$b;->f:I
    ...
    const-string v0, "waitForInterstitial()-> AppLovinInterstitialManager: Can\'t load interstitial. Timeout reached"
...
.method public final d()Z
    ...
    iget-object v0, p0, Lc6/d;->b:Lkotlinx/coroutines/flow/s;
    ...
    instance-of v2, v0, Lcom/zipoapps/premiumhelper/util/I$c;
...
.method public final e()Lq6/d;
    ...
    iget-object v1, p0, Lc6/d;->a:Lq6/e;
