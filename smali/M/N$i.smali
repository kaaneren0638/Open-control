...
.method public static b(Landroid/view/View;LM/p0;Landroid/graphics/Rect;)LM/p0;
    .locals 1
...
.method public static j(Landroid/view/View;)LM/p0;
    .locals 7

    sget-boolean v0, LM/p0$a;->d:Z
    ...
    :try_start_0
    sget-object v2, LM/p0$a;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, LM/p0$a;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, LM/p0$a;->c:Ljava/lang/reflect/Field;
    ...
    new-instance v3, LM/p0$d;

    invoke-direct {v3}, LM/p0$d;-><init>()V
    ...
    new-instance v3, LM/p0$c;

    invoke-direct {v3}, LM/p0$c;-><init>()V

    goto :goto_0

    :cond_2
    new-instance v3, LM/p0$b;

    invoke-direct {v3}, LM/p0$b;-><init>()V
    ...
    invoke-static {v4, v5, v6, v2}, LE/k;->b(IIII)LE/k;

    move-result-object v2

    invoke-virtual {v3, v2}, LM/p0$e;->e(LE/k;)V
    ...
    invoke-static {v2, v4, v5, v0}, LE/k;->b(IIII)LE/k;

    move-result-object v0

    invoke-virtual {v3, v0}, LM/p0$e;->g(LE/k;)V

    invoke-virtual {v3}, LM/p0$e;->b()LM/p0;

    move-result-object v0

    iget-object v2, v0, LM/p0;->a:LM/p0$k;

    invoke-virtual {v2, v0}, LM/p0$k;->q(LM/p0;)V
    ...
    invoke-virtual {v2, p0}, LM/p0$k;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;LM/E;)V
    .locals 2
    ...
    :cond_1
    new-instance v0, LM/N$i$a;

    invoke-direct {v0, p0, p1}, LM/N$i$a;-><init>(Landroid/view/View;LM/E;)V
