...
.field public final h:Landroidx/appcompat/widget/AppCompatSpinner$h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, p3, v1}, Landroidx/appcompat/widget/a0;->e(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/a0;
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->c:Landroidx/appcompat/widget/e;

    const/4 v3, 0x4

    iget-object v4, v2, Landroidx/appcompat/widget/a0;->b:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v5, p1, v3}, Lh/c;-><init>(Landroid/content/Context;I)V

    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->d:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v6, Landroidx/appcompat/widget/AppCompatSpinner;->k:[I
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/AppCompatSpinner;->d:Landroid/content/Context;

    invoke-direct {v3, p0, v8, p2, p3}, Landroidx/appcompat/widget/AppCompatSpinner$g;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v8, p0, Landroidx/appcompat/widget/AppCompatSpinner;->d:Landroid/content/Context;

    invoke-static {v8, p2, v0, p3, v1}, Landroidx/appcompat/widget/a0;->e(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/a0;

    move-result-object v0

    iget-object v8, v0, Landroidx/appcompat/widget/a0;->b:Landroid/content/res/TypedArray;
    ...
    iput v8, p0, Landroidx/appcompat/widget/AppCompatSpinner;->i:I

    invoke-virtual {v0, v7}, Landroidx/appcompat/widget/a0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    invoke-virtual {v3, v8}, Landroidx/appcompat/widget/J;->j(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v4, v6}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v3, Landroidx/appcompat/widget/AppCompatSpinner$g;->E:Ljava/lang/CharSequence;

    invoke-virtual {v0}, Landroidx/appcompat/widget/a0;->f()V

    iput-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;

    new-instance v0, Landroidx/appcompat/widget/x;

    invoke-direct {v0, p0, p0, v3}, Landroidx/appcompat/widget/x;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/view/View;Landroidx/appcompat/widget/AppCompatSpinner$g;)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->e:Landroidx/appcompat/widget/x;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;

    invoke-virtual {v4, v6}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v0, Landroidx/appcompat/widget/AppCompatSpinner$e;->e:Ljava/lang/CharSequence;
    ...
    :cond_5
    invoke-virtual {v2}, Landroidx/appcompat/widget/a0;->f()V

    iput-boolean v7, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Z
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->f:Landroid/widget/SpinnerAdapter;
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$h;->b()Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->e:Landroidx/appcompat/widget/x;
...
.method public final performClick()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/AppCompatSpinner$h;

    invoke-interface {v2, v0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$h;->m(II)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 9
    iput-object p1, v2, Landroidx/appcompat/widget/AppCompatSpinner$f;->c:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v3, v2, Landroidx/appcompat/widget/AppCompatSpinner$f;->d:Landroid/widget/ListAdapter;
    ...
    .line 14
    invoke-static {p1, v1}, Landroidx/appcompat/widget/AppCompatSpinner$d;->a(Landroid/widget/ThemedSpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    goto :goto_0

    .line 15
    :cond_3
    instance-of v1, p1, Landroidx/appcompat/widget/W;
    ...
    .line 18
    invoke-interface {p1}, Landroidx/appcompat/widget/W;->v()V

    .line 19
    :cond_4
    :goto_0
    invoke-interface {v0, v2}, Landroidx/appcompat/widget/AppCompatSpinner$h;->o(Landroid/widget/ListAdapter;)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$h;->j(Landroid/graphics/drawable/Drawable;)V
