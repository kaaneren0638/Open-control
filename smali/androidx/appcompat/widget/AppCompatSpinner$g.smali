...
.method public constructor <init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p4, v0}, Landroidx/appcompat/widget/J;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/J;->q:Landroid/view/View;

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroidx/appcompat/widget/J;->A:Z

    iget-object p2, p0, Landroidx/appcompat/widget/J;->B:Landroidx/appcompat/widget/r;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/J;->r:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public final m(II)V
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/J;->B:Landroidx/appcompat/widget/r;

    invoke-virtual {v3, v2}, Landroid/widget/PopupWindow;->setInputMethodMode(I)V

    invoke-virtual {p0}, Landroidx/appcompat/widget/J;->show()V
    ...
    invoke-virtual {v2, v0}, Landroidx/appcompat/widget/F;->setListSelectionHidden(Z)V
...
.method public final o(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/J;->o(Landroid/widget/ListAdapter;)V
...
.method public final r()V
    ...
    iget-object v3, v2, Landroidx/appcompat/widget/AppCompatSpinner;->j:Landroid/graphics/Rect;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    invoke-static {v2}, Landroidx/appcompat/widget/i0;->a(Landroid/view/View;)Z
    ...
    :cond_1
    iget-object v1, v2, Landroidx/appcompat/widget/AppCompatSpinner;->j:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner$g;->F:Landroid/widget/ListAdapter;
    ...
    iget-object v7, v2, Landroidx/appcompat/widget/AppCompatSpinner;->j:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/J;->q(I)V
    ...
    :cond_4
    invoke-virtual {p0, v6}, Landroidx/appcompat/widget/J;->q(I)V
    ...
    :goto_2
    iput v5, p0, Landroidx/appcompat/widget/J;->h:I
