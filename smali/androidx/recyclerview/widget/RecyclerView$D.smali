...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$D;->i:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->sQuinticInterpolator:Landroid/view/animation/Interpolator;

    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$D;->f:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$D;->g:Z

    iput-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$D;->h:Z
    ...
    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$D;->e:Landroid/widget/OverScroller;
...
.method public final a(II)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$D;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$D;->f:Landroid/view/animation/Interpolator;

    sget-object v2, Landroidx/recyclerview/widget/RecyclerView;->sQuinticInterpolator:Landroid/view/animation/Interpolator;

    if-eq v1, v2, :cond_0

    iput-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$D;->f:Landroid/view/animation/Interpolator;
    ...
    :cond_0
    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView$D;->e:Landroid/widget/OverScroller;
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$D;->b()V
...
.method public final b()V
    ...
    iget-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$D;->g:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$D;->h:Z
...
.method public final c(IILandroid/view/animation/Interpolator;I)V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/RecyclerView$D;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_4
    iget-object p4, p0, Landroidx/recyclerview/widget/RecyclerView$D;->f:Landroid/view/animation/Interpolator;

    if-eq p4, p3, :cond_5

    iput-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$D;->f:Landroid/view/animation/Interpolator;
    ...
    iput-object p4, p0, Landroidx/recyclerview/widget/RecyclerView$D;->e:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v9, v0, Landroidx/recyclerview/widget/RecyclerView$D;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$D;->e:Landroid/widget/OverScroller;
    ...
    iput-boolean v10, v0, Landroidx/recyclerview/widget/RecyclerView$D;->h:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, Landroidx/recyclerview/widget/RecyclerView$D;->g:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->consumePendingUpdateOperations()V

    iget-object v12, v0, Landroidx/recyclerview/widget/RecyclerView$D;->e:Landroid/widget/OverScroller;
    ...
    iget v4, v0, Landroidx/recyclerview/widget/RecyclerView$D;->d:I

    sub-int v4, v2, v4

    iput v1, v0, Landroidx/recyclerview/widget/RecyclerView$D;->c:I

    iput v2, v0, Landroidx/recyclerview/widget/RecyclerView$D;->d:I
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView$p;->e:Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$A;
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$z;->f()V
    ...
    invoke-virtual {v3, v2, v1}, Landroidx/recyclerview/widget/RecyclerView$z;->b(II)V
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView$p;->e:Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    :cond_16
    iput v10, v1, Landroidx/recyclerview/widget/j$b;->d:I

    goto :goto_9

    :cond_17
    :goto_8
    invoke-virtual/range {p0 .. p0}, Landroidx/recyclerview/widget/RecyclerView$D;->b()V

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mGapWorker:Landroidx/recyclerview/widget/j;

    if-eqz v1, :cond_18

    invoke-virtual {v1, v9, v15, v14}, Landroidx/recyclerview/widget/j;->a(Landroidx/recyclerview/widget/RecyclerView;II)V

    :cond_18
    :goto_9
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/RecyclerView$p;

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView$p;->e:Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    :cond_19
    iput-boolean v10, v0, Landroidx/recyclerview/widget/RecyclerView$D;->g:Z

    iget-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView$D;->h:Z
    ...
    invoke-static {v9, v0}, LM/N$d;->m(Landroid/view/View;Ljava/lang/Runnable;)V
