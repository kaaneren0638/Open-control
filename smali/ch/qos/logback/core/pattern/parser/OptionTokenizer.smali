...
.field final tokenStream:Lch/qos/logback/core/pattern/parser/c;
...
.method public constructor <init>(Lch/qos/logback/core/pattern/parser/c;)V
    ...
    invoke-direct {p0, p1, v0}, Lch/qos/logback/core/pattern/parser/OptionTokenizer;-><init>(Lch/qos/logback/core/pattern/parser/c;Lch/qos/logback/core/pattern/util/IEscapeUtil;)V

    return-void
.end method

.method public constructor <init>(Lch/qos/logback/core/pattern/parser/c;Lch/qos/logback/core/pattern/util/IEscapeUtil;)V
    .locals 1
    ...
    iput-object p1, p0, Lch/qos/logback/core/pattern/parser/OptionTokenizer;->tokenStream:Lch/qos/logback/core/pattern/parser/c;

    iget-object v0, p1, Lch/qos/logback/core/pattern/parser/c;->a:Ljava/lang/String;

    iput-object v0, p0, Lch/qos/logback/core/pattern/parser/OptionTokenizer;->pattern:Ljava/lang/String;

    iget p1, p1, Lch/qos/logback/core/pattern/parser/c;->b:I
...
.method public emitOptionToken(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v0, v1, v2, p2}, Lch/qos/logback/core/pattern/parser/b;-><init>(Ljava/lang/String;ILjava/util/List;)V

    invoke-interface {p1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lch/qos/logback/core/pattern/parser/OptionTokenizer;->tokenStream:Lch/qos/logback/core/pattern/parser/c;

    sget-object p2, Lch/qos/logback/core/pattern/parser/c$b;->LITERAL_STATE:Lch/qos/logback/core/pattern/parser/c$b;

    iput-object p2, p1, Lch/qos/logback/core/pattern/parser/c;->d:Lch/qos/logback/core/pattern/parser/c$b;
...
.method public escape(Ljava/lang/String;Ljava/lang/StringBuffer;)V
    ...
    iget-object v0, p0, Lch/qos/logback/core/pattern/parser/OptionTokenizer;->tokenStream:Lch/qos/logback/core/pattern/parser/c;

    iget v1, v0, Lch/qos/logback/core/pattern/parser/c;->e:I
    ...
    iput v3, v0, Lch/qos/logback/core/pattern/parser/c;->e:I
    ...
    iget-object v2, p0, Lch/qos/logback/core/pattern/parser/OptionTokenizer;->tokenStream:Lch/qos/logback/core/pattern/parser/c;

    iget v2, v2, Lch/qos/logback/core/pattern/parser/c;->e:I
...
.method public tokenize(CLjava/util/List;)V
    ...
    iget v3, v2, Lch/qos/logback/core/pattern/parser/c;->e:I

    add-int/2addr v3, v5

    iput v3, v2, Lch/qos/logback/core/pattern/parser/c;->e:I
