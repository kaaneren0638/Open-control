...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover$b;
    }
.end annotation


# instance fields
.field private final dateParser:Lch/qos/logback/core/rolling/helper/a;
...
.field private final fileSorter:Lch/qos/logback/core/rolling/helper/c;
...
.method public constructor <init>(Lch/qos/logback/core/rolling/helper/FileNamePattern;Lch/qos/logback/core/rolling/helper/RollingCalendar;Lch/qos/logback/core/rolling/helper/FileProvider;)V
    ...
    new-instance p2, Lch/qos/logback/core/rolling/helper/a;

    invoke-direct {p2, p1}, Lch/qos/logback/core/rolling/helper/a;-><init>(Lch/qos/logback/core/rolling/helper/FileNamePattern;)V

    iput-object p2, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->dateParser:Lch/qos/logback/core/rolling/helper/a;

    new-instance p3, Lch/qos/logback/core/rolling/helper/c;

    new-instance v1, Lch/qos/logback/core/rolling/helper/e;

    invoke-direct {v1, p1}, Lch/qos/logback/core/rolling/helper/e;-><init>(Lch/qos/logback/core/rolling/helper/FileNamePattern;)V

    const/4 p1, 0x2

    new-array p1, p1, [Lch/qos/logback/core/rolling/helper/d;
    ...
    invoke-direct {p3, p1}, Lch/qos/logback/core/rolling/helper/c;-><init>([Lch/qos/logback/core/rolling/helper/d;)V

    iput-object p3, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->fileSorter:Lch/qos/logback/core/rolling/helper/c;

    return-void
.end method

.method public static synthetic access$000(Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;)Lch/qos/logback/core/rolling/helper/a;
    .locals 0

    iget-object p0, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->dateParser:Lch/qos/logback/core/rolling/helper/a;
...
.method private capTotalSize(Ljava/util/List;)V
    ...
    iget-object v3, v0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->fileSorter:Lch/qos/logback/core/rolling/helper/c;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v4, Lch/qos/logback/core/rolling/helper/b;

    invoke-direct {v4, v3}, Lch/qos/logback/core/rolling/helper/b;-><init>(Lch/qos/logback/core/rolling/helper/c;)V
...
.method private createExpiredFileFilter(Ljava/util/Date;)Ljava/io/FilenameFilter;
    ...
    new-instance v0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover$a;

    invoke-direct {v0, p0, p1}, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover$a;-><init>(Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;Ljava/util/Date;)V
...
.method private findEmptyDirs()Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/ads/Km;-><init>(Ljava/lang/Object;)V

    iget-object v2, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->fileNamePattern:Lch/qos/logback/core/rolling/helper/FileNamePattern;

    invoke-virtual {v2}, Lch/qos/logback/core/rolling/helper/FileNamePattern;->toRegex()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lcom/google/android/gms/internal/ads/Km;->f(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v4, Lch/qos/logback/core/rolling/helper/g;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {v4, v1}, Lch/qos/logback/core/rolling/helper/g;->a(Lch/qos/logback/core/rolling/helper/FileProvider;)Ljava/util/List;

    move-result-object v1

    const/4 v4, 0x1

    invoke-virtual {v0, v1, v2, v4, v5}, Lcom/google/android/gms/internal/ads/Km;->a(Ljava/util/List;Ljava/util/ArrayList;ILjava/util/ArrayList;)V
    ...
    iget-object v5, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->fileProvider:Lch/qos/logback/core/rolling/helper/FileProvider;
    ...
    invoke-interface {v5, v6, v7}, Lch/qos/logback/core/rolling/helper/FileProvider;->list(Ljava/io/File;Ljava/io/FilenameFilter;)[Ljava/lang/String;
...
.method private findFiles()Ljava/util/List;
    ...
    check-cast v3, Lch/qos/logback/core/rolling/helper/g;

    invoke-virtual {v3, v1}, Lch/qos/logback/core/rolling/helper/g;->a(Lch/qos/logback/core/rolling/helper/FileProvider;)Ljava/util/List;

    move-result-object v1

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/gms/internal/ads/Km;->b(Ljava/util/List;Ljava/util/ArrayList;I)Ljava/util/ArrayList;
...
.method public cleanAsynchronously(Ljava/util/Date;)Ljava/util/concurrent/Future;
    ...
    new-instance v0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover$b;

    invoke-direct {v0, p0, p1}, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover$b;-><init>(Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;Ljava/util/Date;)V
