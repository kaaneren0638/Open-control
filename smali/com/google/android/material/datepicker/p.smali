...
.field public t0:Lcom/google/android/material/datepicker/y;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public w0:Lcom/google/android/material/datepicker/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static f0(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v1, v0}, LI2/b;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/util/TypedValue;
...
.method public final A(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/p;->v0:Lcom/google/android/material/datepicker/DayViewDecorator;
    ...
    iput v0, p0, Lcom/google/android/material/datepicker/p;->A0:I
    ...
    iput v0, p0, Lcom/google/android/material/datepicker/p;->D0:I
    ...
    iput-object p1, p0, Lcom/google/android/material/datepicker/p;->E0:Ljava/lang/CharSequence;

    iget-object p1, p0, Lcom/google/android/material/datepicker/p;->y0:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/datepicker/p;->L0:Ljava/lang/CharSequence;
...
.method public final B(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-boolean p3, p0, Lcom/google/android/material/datepicker/p;->z0:Z
    ...
    iget-object p3, p0, Lcom/google/android/material/datepicker/p;->v0:Lcom/google/android/material/datepicker/DayViewDecorator;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/p;->e0(Landroid/content/Context;)I
    ...
    iput-object p3, p0, Lcom/google/android/material/datepicker/p;->G0:Landroid/widget/TextView;

    sget-object v0, LM/N;->a:Ljava/util/WeakHashMap;

    const/4 v0, 0x1

    invoke-static {p3, v0}, LM/N$g;->f(Landroid/view/View;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iput-object p3, p0, Lcom/google/android/material/datepicker/p;->F0:Landroid/widget/TextView;

    iget-object p3, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p2, v4}, Le/a;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;

    iget p3, p0, Lcom/google/android/material/datepicker/p;->A0:I
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/material/datepicker/p;->h0(Lcom/google/android/material/internal/CheckableImageButton;)V

    iget-object p2, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;

    new-instance p3, Lcom/google/android/material/datepicker/r;

    invoke-direct {p3, p0}, Lcom/google/android/material/datepicker/r;-><init>(Lcom/google/android/material/datepicker/p;)V
    ...
    iput-object p2, p0, Lcom/google/android/material/datepicker/p;->J0:Landroid/widget/Button;

    invoke-virtual {p0}, Lcom/google/android/material/datepicker/p;->d0()Lcom/google/android/material/datepicker/DateSelector;
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/p;->J0:Landroid/widget/Button;
    ...
    iget-object p2, p0, Lcom/google/android/material/datepicker/p;->C0:Ljava/lang/CharSequence;

    if-eqz p2, :cond_5

    iget-object p3, p0, Lcom/google/android/material/datepicker/p;->J0:Landroid/widget/Button;
    ...
    :cond_5
    iget p2, p0, Lcom/google/android/material/datepicker/p;->B0:I
    ...
    iget-object p3, p0, Lcom/google/android/material/datepicker/p;->E0:Ljava/lang/CharSequence;
    ...
    :cond_7
    iget p3, p0, Lcom/google/android/material/datepicker/p;->D0:I
    ...
    :cond_8
    :goto_5
    new-instance p3, Lcom/google/android/material/datepicker/p$c;

    invoke-direct {p3, p0}, Lcom/google/android/material/datepicker/p$c;-><init>(Lcom/google/android/material/datepicker/p;)V
...
.method public final I(Landroid/os/Bundle;)V
    ...
    invoke-super/range {p0 .. p1}, Landroidx/fragment/app/l;->I(Landroid/os/Bundle;)V
    ...
    iget-object v3, v0, Lcom/google/android/material/datepicker/p;->s0:Lcom/google/android/material/datepicker/DateSelector;

    invoke-virtual {v1, v2, v3}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    new-instance v2, Lcom/google/android/material/datepicker/CalendarConstraints$b;

    iget-object v3, v0, Lcom/google/android/material/datepicker/p;->u0:Lcom/google/android/material/datepicker/CalendarConstraints;
    ...
    iget-object v9, v0, Lcom/google/android/material/datepicker/p;->w0:Lcom/google/android/material/datepicker/h;
    ...
    :cond_0
    iget-object v9, v9, Lcom/google/android/material/datepicker/h;->c0:Lcom/google/android/material/datepicker/Month;
    ...
    iget-object v3, v0, Lcom/google/android/material/datepicker/p;->v0:Lcom/google/android/material/datepicker/DayViewDecorator;
    ...
    iget v3, v0, Lcom/google/android/material/datepicker/p;->D0:I

    invoke-virtual {v1, v2, v3}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "NEGATIVE_BUTTON_TEXT_KEY"

    iget-object v3, v0, Lcom/google/android/material/datepicker/p;->E0:Ljava/lang/CharSequence;
...
.method public final J()V
    ...
    iget-boolean v3, p0, Lcom/google/android/material/datepicker/p;->z0:Z
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/p;->I0:LL2/g;

    invoke-virtual {v0, v1}, Landroid/view/Window;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-boolean v1, p0, Lcom/google/android/material/datepicker/p;->K0:Z
    ...
    invoke-static {v6, v7, v8}, Lkotlinx/coroutines/G;->f(Landroid/content/Context;II)I
    ...
    invoke-static {v0, v3}, LM/f0;->a(Landroid/view/Window;Z)V

    goto :goto_3

    :cond_5
    invoke-static {v0, v3}, LM/e0;->a(Landroid/view/Window;Z)V
    ...
    invoke-static {v2}, Lkotlinx/coroutines/G;->j(I)Z

    move-result v2

    invoke-static {v3}, Lkotlinx/coroutines/G;->j(I)Z
    ...
    new-instance v5, LM/C0$d;

    invoke-static {v0}, LH0/k;->b(Landroid/view/Window;)Landroid/view/WindowInsetsController;

    move-result-object v8

    invoke-direct {v5, v8}, LM/C0$d;-><init>(Landroid/view/WindowInsetsController;)V

    iput-object v0, v5, LM/C0$d;->b:Landroid/view/Window;

    goto :goto_6

    :cond_8
    new-instance v8, LM/C0$c;

    invoke-direct {v8, v0, v5}, LM/C0$a;-><init>(Landroid/view/Window;Landroid/view/View;)V

    move-object v5, v8

    :goto_6
    invoke-virtual {v5, v2}, LM/C0$e;->d(Z)V

    invoke-static {v6}, Lkotlinx/coroutines/G;->j(I)Z
    ...
    new-instance v2, LM/C0$d;

    invoke-static {v0}, LH0/k;->b(Landroid/view/Window;)Landroid/view/WindowInsetsController;

    move-result-object v5

    invoke-direct {v2, v5}, LM/C0$d;-><init>(Landroid/view/WindowInsetsController;)V

    iput-object v0, v2, LM/C0$d;->b:Landroid/view/Window;

    goto :goto_7

    :cond_b
    new-instance v5, LM/C0$c;

    invoke-direct {v5, v0, v2}, LM/C0$a;-><init>(Landroid/view/Window;Landroid/view/View;)V

    move-object v2, v5

    :goto_7
    invoke-virtual {v2, v3}, LM/C0$e;->c(Z)V
    ...
    invoke-static {v1, v3}, LM/N$i;->u(Landroid/view/View;LM/E;)V

    iput-boolean v4, p0, Lcom/google/android/material/datepicker/p;->K0:Z
    ...
    iget-object v6, p0, Lcom/google/android/material/datepicker/p;->I0:LL2/g;
    ...
    invoke-direct {v4, v5, v3}, LA2/a;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V

    invoke-virtual {v0, v4}, Landroid/view/View;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    :goto_8
    invoke-virtual {p0}, Lcom/google/android/material/datepicker/p;->g0()V
...
.method public final K()V
    ...
    iget-object v0, p0, Lcom/google/android/material/datepicker/p;->t0:Lcom/google/android/material/datepicker/y;

    iget-object v0, v0, Lcom/google/android/material/datepicker/y;->X:Ljava/util/LinkedHashSet;

    invoke-virtual {v0}, Ljava/util/AbstractCollection;->clear()V

    invoke-super {p0}, Landroidx/fragment/app/l;->K()V
...
.method public final Z(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-interface {v2, v1}, Lcom/google/android/material/datepicker/DateSelector;->Y(Landroid/content/Context;)I
    ...
    invoke-static {v0, v1}, Lcom/google/android/material/datepicker/p;->f0(Landroid/content/Context;I)Z

    move-result v1

    iput-boolean v1, p0, Lcom/google/android/material/datepicker/p;->z0:Z
    ...
    invoke-static {v0, v2, v1}, LI2/b;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/util/TypedValue;
    ...
    invoke-direct {v2, v0, v4, v5, v3}, LL2/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Lcom/google/android/material/datepicker/p;->I0:LL2/g;

    invoke-virtual {v2, v0}, LL2/g;->k(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/p;->I0:LL2/g;
    ...
    invoke-virtual {v0, v1}, LL2/g;->m(F)V

    return-object p1
.end method

.method public final d0()Lcom/google/android/material/datepicker/DateSelector;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final g0()V
    ...
    invoke-interface {v1, v0}, Lcom/google/android/material/datepicker/DateSelector;->Y(Landroid/content/Context;)I
    ...
    iget-object v3, p0, Lcom/google/android/material/datepicker/p;->v0:Lcom/google/android/material/datepicker/DayViewDecorator;
    ...
    iput-object v4, p0, Lcom/google/android/material/datepicker/p;->w0:Lcom/google/android/material/datepicker/h;

    iget-object v2, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;

    iget-boolean v2, v2, Lcom/google/android/material/internal/CheckableImageButton;->f:Z
    ...
    iget-object v4, p0, Lcom/google/android/material/datepicker/p;->u0:Lcom/google/android/material/datepicker/CalendarConstraints;

    new-instance v5, Lcom/google/android/material/datepicker/t;

    invoke-direct {v5}, Lcom/google/android/material/datepicker/t;-><init>()V
    ...
    invoke-virtual {v5, v7}, Landroidx/fragment/app/Fragment;->U(Landroid/os/Bundle;)V

    move-object v4, v5

    :cond_1
    iput-object v4, p0, Lcom/google/android/material/datepicker/p;->t0:Lcom/google/android/material/datepicker/y;

    iget-object v0, p0, Lcom/google/android/material/datepicker/p;->F0:Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v1, p0, Lcom/google/android/material/datepicker/p;->L0:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/p;->G0:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/p;->t0:Lcom/google/android/material/datepicker/y;

    invoke-virtual {v1, v0, v2}, Landroidx/fragment/app/M;->e(ILandroidx/fragment/app/Fragment;)V

    invoke-virtual {v1}, Landroidx/fragment/app/M;->c()V

    iget-object v0, v1, Landroidx/fragment/app/a;->q:Landroidx/fragment/app/FragmentManager;

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroidx/fragment/app/FragmentManager;->y(Landroidx/fragment/app/FragmentManager$m;Z)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/p;->t0:Lcom/google/android/material/datepicker/y;

    new-instance v1, Lcom/google/android/material/datepicker/p$d;

    invoke-direct {v1, p0}, Lcom/google/android/material/datepicker/p$d;-><init>(Lcom/google/android/material/datepicker/p;)V

    invoke-virtual {v0, v1}, Lcom/google/android/material/datepicker/y;->X(Lcom/google/android/material/datepicker/p$d;)V

    return-void
.end method

.method public final h0(Lcom/google/android/material/internal/CheckableImageButton;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/datepicker/p;->H0:Lcom/google/android/material/internal/CheckableImageButton;
