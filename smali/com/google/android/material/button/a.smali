...
# direct methods
.method public constructor <init>(Lcom/google/android/material/button/MaterialButton;LL2/k;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/google/android/material/button/a;->b:LL2/k;
...
.method public final c(LL2/k;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/button/a;->b:LL2/k;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lcom/google/android/material/button/a;->b(Z)LL2/g;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/material/button/a;->a()LL2/o;
    ...
    invoke-interface {v0, p1}, LL2/o;->setShapeAppearanceModel(LL2/k;)V
...
.method public final d(II)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, LM/N$e;->k(Landroid/view/View;IIII)V
...
.method public final e()V
    ...
    iget-object v2, p0, Lcom/google/android/material/button/a;->b:LL2/k;
    ...
    invoke-virtual {v1, v3}, LL2/g;->k(Landroid/content/Context;)V

    iget-object v3, p0, Lcom/google/android/material/button/a;->j:Landroid/content/res/ColorStateList;

    invoke-static {v1, v3}, LF/a$b;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    iget-object v3, p0, Lcom/google/android/material/button/a;->i:Landroid/graphics/PorterDuff$Mode;

    if-eqz v3, :cond_0

    invoke-static {v1, v3}, LF/a$b;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v1, v3}, LL2/g;->s(F)V

    invoke-virtual {v1, v4}, LL2/g;->r(Landroid/content/res/ColorStateList;)V

    new-instance v3, LL2/g;

    iget-object v4, p0, Lcom/google/android/material/button/a;->b:LL2/k;

    invoke-direct {v3, v4}, LL2/g;-><init>(LL2/k;)V

    invoke-virtual {v3, v0}, LL2/g;->setTint(I)V
    ...
    invoke-static {v5, v2}, Lkotlinx/coroutines/G;->e(ILandroid/view/View;)I
    ...
    :goto_0
    invoke-virtual {v3, v4}, LL2/g;->s(F)V

    invoke-static {v5}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v4

    invoke-virtual {v3, v4}, LL2/g;->r(Landroid/content/res/ColorStateList;)V

    new-instance v4, LL2/g;

    iget-object v5, p0, Lcom/google/android/material/button/a;->b:LL2/k;

    invoke-direct {v4, v5}, LL2/g;-><init>(LL2/k;)V

    iput-object v4, p0, Lcom/google/android/material/button/a;->m:LL2/g;

    const/4 v5, -0x1

    invoke-static {v4, v5}, LF/a$b;->g(Landroid/graphics/drawable/Drawable;I)V
    ...
    iget-object v3, p0, Lcom/google/android/material/button/a;->m:LL2/g;
...
.method public final f()V
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/material/button/a;->b(Z)LL2/g;
    ...
    invoke-static {v3, v0}, Lkotlinx/coroutines/G;->e(ILandroid/view/View;)I

    move-result v0

    :cond_0
    invoke-virtual {v2, v1}, LL2/g;->s(F)V

    invoke-static {v0}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-virtual {v2, v0}, LL2/g;->r(Landroid/content/res/ColorStateList;)V
