...
.method public final e(Lm0/f;Ljava/lang/Object;)V
    ...
    :goto_0
    iget-object v0, p2, LG0/w;->b:Lx0/t$a;
    ...
    iget-object v0, p2, LG0/w;->c:Ljava/lang/String;
    ...
    :goto_1
    iget-object v0, p2, LG0/w;->d:Ljava/lang/String;
    ...
    :goto_2
    iget-object v0, p2, LG0/w;->e:Landroidx/work/b;
    ...
    :cond_3
    invoke-interface {p1, v1, v0}, Lm0/d;->m(I[B)V

    :goto_3
    iget-object v0, p2, LG0/w;->f:Landroidx/work/b;
    ...
    iget-wide v1, p2, LG0/w;->g:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    const/16 v0, 0x8

    iget-wide v1, p2, LG0/w;->h:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    const/16 v0, 0x9

    iget-wide v1, p2, LG0/w;->i:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    iget v0, p2, LG0/w;->k:I
    ...
    iget-object v0, p2, LG0/w;->l:Lx0/a;

    invoke-static {v0}, LG0/C;->a(Lx0/a;)I
    ...
    iget-wide v1, p2, LG0/w;->m:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    const/16 v0, 0xd

    iget-wide v1, p2, LG0/w;->n:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    const/16 v0, 0xe

    iget-wide v1, p2, LG0/w;->o:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    const/16 v0, 0xf

    iget-wide v1, p2, LG0/w;->p:J

    invoke-interface {p1, v0, v1, v2}, Lm0/d;->k(IJ)V

    iget-boolean v0, p2, LG0/w;->q:Z
    ...
    iget-object v0, p2, LG0/w;->r:Lx0/r;

    invoke-static {v0}, LG0/C;->h(Lx0/r;)I
    ...
    iget-object v8, p2, Lx0/c;->a:Lx0/o;

    invoke-static {v8}, LG0/C;->g(Lx0/o;)I
    ...
    invoke-interface {p1, v0, p2}, Lm0/d;->m(I[B)V
